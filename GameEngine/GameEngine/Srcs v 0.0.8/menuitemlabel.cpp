...
MenuItemLabel::MenuItemLabel(const QString &text,QColor *color,int fontSize,QString font,QObject* target,const char* slot) {
    item = new textItem;
...
MenuItemLabel* MenuItemLabel::LabelWith(const char *text, QColor *color, int fontSize, QString font, QObject *target, const char *slot) {
    MenuItemLabel* newlabelbutton = new MenuItemLabel(QString(text),color,fontSize,font,target,slot);
