...
**
** Created: Thu Feb 9 19:14:47 2012
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "Srcs/action.h"
...
void action::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->animationFinished((*reinterpret_cast< action*(*)>(_a[1]))); break;
        case 1: _t->delete_self(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData action::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject action::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_action,
      qt_meta_data_action, &staticMetaObjectExtraData }
};
