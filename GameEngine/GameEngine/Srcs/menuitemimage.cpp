...
MenuItemImage::MenuItemImage(const QString &filename, const QString &clickedfilename, QObject *target, const QString slot, bool isVector, float scale) {
...
MenuItemImage* MenuItemImage::itemWith(const QString image,const QString clicked_image ,QObject* target,const QString slot) {
    MenuItemImage* newimagebutton = new MenuItemImage(QString(image),QString(clicked_image),target,slot,false);
    return newimagebutton;
}

MenuItemImage* MenuItemImage::itemWithSVG(const QString image,const QString clicked_image ,QObject* target,const QString slot,float scale) {
    MenuItemImage* newimagebutton = new MenuItemImage(QString(image),QString(clicked_image),target,slot,true,scale);
    return newimagebutton;
}
