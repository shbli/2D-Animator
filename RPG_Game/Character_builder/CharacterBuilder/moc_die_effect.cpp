...
**
** Created: Thu Jun 14 21:21:21 2012
...
void die_and_join_effect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        die_and_join_effect *_t = static_cast<die_and_join_effect *>(_o);
        switch (_id) {
        case 0: _t->startDieEffect((*reinterpret_cast< character_base*(*)>(_a[1]))); break;
        case 1: _t->hideDeadCharacter(); break;
        case 2: _t->update((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->deleteSelfFromParent(); break;
        case 4: _t->finalStep(); break;
        case 5: _t->startEnterEffect(); break;
        case 6: _t->enterEffectShowParentHideEffect(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData die_and_join_effect::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject die_and_join_effect::staticMetaObject = {
    { &Layer::staticMetaObject, qt_meta_stringdata_die_and_join_effect,
      qt_meta_data_die_and_join_effect, &staticMetaObjectExtraData }
};
