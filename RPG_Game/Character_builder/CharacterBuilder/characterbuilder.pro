...
include(../../../GameEngine/GameEngine/Srcs/engine.pri)
include(../../skeltal/skeltal.pri)
include(../../character/character.pri)
include(../../weapon/weapon.pri)
include(../../health_bar/health_bar.pri)
include(../../game_controller/game_controller.pri)
include(../../numbers/numbers.pri)
include(../../map/map.pri)
