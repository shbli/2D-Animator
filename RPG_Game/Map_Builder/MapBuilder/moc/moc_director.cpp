...
**
** Created: Fri Nov 16 17:46:08 2012
...
int Director::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: update((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: refreshAndroidScreen(); break;
        case 2: updatedEveryFrameRate(); break;
        case 3: updatedEveryFrameRateOpenGL(); break;
        case 4: transitionDone((*reinterpret_cast< Scene*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 5;
    }
